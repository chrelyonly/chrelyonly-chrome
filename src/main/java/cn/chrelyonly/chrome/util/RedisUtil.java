...
//	************************************通过 类名.方法 访问 ******************************
     ...
     * 必须是public
     */
    public static RedisTemplate<String, Object> redisTemplateStatic = null;
     ...
     * @param mini 时间/秒
     */
    public static void setObjectStatic(String key, Object value,long mini) {
        redisTemplateStatic.opsForValue ().set (key, value);
        redisTemplateStatic.expire(key,mini,TimeUnit.SECONDS);
    }
    /**
     * 传入key
     * @return 返回 value
...
//	***************************************以下通过 注入访问*****************************
     ...
     * @param mini
     */
    public void setObject(String key, Object value,long mini) {
        redisTemplate.opsForValue ().set (key, value);
        this.expire(key,mini,TimeUnit.SECONDS);
    }
